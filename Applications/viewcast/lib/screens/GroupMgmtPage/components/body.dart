...
import 'package:viewcast/screens/GroupMgmtPage/components/list.dart';
import 'package:viewcast/screens/GroupMgmtPage/components/pre_list.dart';
            ...
            child: Container(
              ...
              child: Flex(
                ...
                children: [
                  ...
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).groupName,
                      flex: 2),
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).groupDisplays,
                      flex: 2),
                  IconButton(
