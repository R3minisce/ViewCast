...
import 'package:viewcast/screens/DisplayMgmtPage/components/body.dart';
...
class DisplayMgmtPage extends StatelessWidget {
  const DisplayMgmtPage({Key? key}) : super(key: key);
