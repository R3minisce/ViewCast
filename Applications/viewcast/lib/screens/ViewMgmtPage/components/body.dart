...
import 'package:viewcast/screens/ViewMgmtPage/components/list.dart';
import 'package:viewcast/screens/ViewMgmtPage/components/pre_list.dart';
            ...
            child: Container(
              ...
              child: Flex(
                ...
                children: [
                  ...
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).viewName, flex: 2),
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).viewFiles,
                      flex: 2),
                  IconButton(
