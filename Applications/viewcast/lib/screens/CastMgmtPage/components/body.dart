...
import 'package:viewcast/screens/CastMgmtPage/components/list.dart';
import 'package:viewcast/screens/CastMgmtPage/components/pre_list.dart';
            ...
            child: Container(
              ...
              child: Flex(
                ...
                children: [
                  ...
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).castRowLabel,
                      flex: 10),
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).castRowEvents,
                      flex: 2),
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).castRowGroups,
                      flex: 2),
                  IconButton(
