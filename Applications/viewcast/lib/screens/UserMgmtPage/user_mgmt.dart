...
import 'package:viewcast/screens/UserMgmtPage/components/body.dart';
...
class UserMgmtPage extends StatelessWidget {
  const UserMgmtPage({Key? key}) : super(key: key);
            ...
            return Stack(
              children: [
                ...
                if (isLogged && !user.admin!)
                  NotAuthPage(
                      error: CustomLocalizations.of(context).notEnoughPerms),
                if (isLogged && user.admin!)
                  SizedBox(
