...
import 'package:viewcast/screens/UserMgmtPage/components/list.dart';
import 'package:viewcast/screens/UserMgmtPage/components/pre_list.dart';
            ...
            child: Container(
              ...
              child: Flex(
                ...
                children: [
                  ...
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).username, flex: 2),
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).creationDate,
                      flex: 2),
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).userGroups,
                      flex: 2),
                  ColumnRowItem(
                      label: CustomLocalizations.of(context).userAdmin,
                      flex: 2),
                  IconButton(
