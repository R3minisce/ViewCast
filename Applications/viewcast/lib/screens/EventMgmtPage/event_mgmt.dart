...
import 'package:viewcast/screens/EventMgmtPage/components/body.dart';
...
class EventMgmtPage extends StatelessWidget {
  const EventMgmtPage({Key? key}) : super(key: key);
